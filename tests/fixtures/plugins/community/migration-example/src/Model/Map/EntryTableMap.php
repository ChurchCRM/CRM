...
namespace ChurchCRM\Plugins\MigrationExample\Model\Map;
...
/**
 * This class defines the structure of the 'plugin_migration_example__entries' table.
 *
 *
 *
...
class EntryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Model.Map.EntryTableMap';
     ...
     */
    public const TABLE_NAME = 'plugin_migration_example__entries';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'Entry';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\ChurchCRM\\Plugins\\MigrationExample\\Model\\Entry';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Model.Entry';
     ...
     */
    public const COL_ID = 'plugin_migration_example__entries.id';

    /**
     * the column name for the label field
     */
    public const COL_LABEL = 'plugin_migration_example__entries.label';
    ...
    /**
     * @var class-string<\ChurchCRM\Plugins\MigrationExample\Model\Base\Collection\EntryCollection>
     */
    public const DEFAULT_OBJECT_COLLECTION = '\ChurchCRM\Plugins\MigrationExample\Model\Base\Collection\EntryCollection';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Label', ],
        self::TYPE_CAMELNAME     => ['id', 'label', ],
        self::TYPE_COLNAME       => [EntryTableMap::COL_ID, EntryTableMap::COL_LABEL, ],
        self::TYPE_FIELDNAME     => ['id', 'label', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Label' => 1, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'label' => 1, ],
        self::TYPE_COLNAME       => [EntryTableMap::COL_ID => 0, EntryTableMap::COL_LABEL => 1, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'label' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'entry.id' => 'ID',
        'EntryTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'plugin_migration_example__entries.id' => 'ID',
        'Label' => 'LABEL',
        'Entry.Label' => 'LABEL',
        'label' => 'LABEL',
        'entry.label' => 'LABEL',
        'EntryTableMap::COL_LABEL' => 'LABEL',
        'COL_LABEL' => 'LABEL',
        'plugin_migration_example__entries.label' => 'LABEL',
    ];
    ...
    {
        // attributes
        $this->setName('plugin_migration_example__entries');
        $this->setPhpName('Entry');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\ChurchCRM\\Plugins\\MigrationExample\\Model\\Entry');
    ...
    public static function populateObject(array $row, int $offset = 0, string $indexType = TableMap::TYPE_NUM): array
    {
        ...
        if (($obj = EntryTableMap::getInstanceFromPool($key)) !== null) {
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        ...
        $tableAlias = $alias ?: 'plugin_migration_example__entries';
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['ID']));
        $criteria->addSelectColumn(new LocalColumnExpression($criteria, $tableAlias, $tableMap->columns['LABEL']));
    }
    ...
    {
        if ($alias === null) {
            $criteria->removeSelectColumn(EntryTableMap::COL_ID);
            $criteria->removeSelectColumn(EntryTableMap::COL_LABEL);
        } else {
    ...
    /**
     * @deprecated Delete via model or EntryQuery.
     *
    ...
    {
        trigger_deprecation('Propel', '2.0', 'TableMap::doDelete() should not be used anymore, delete via model or EntryQuery');
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->addAnd(EntryTableMap::COL_ID, (array)$values, Criteria::IN);
        }
     ...
     *
     * @param \Propel\Runtime\ActiveQuery\Criteria|\ChurchCRM\Plugins\MigrationExample\Model\Entry $criteria
    ...
    public static function doInsert($criteria, ?ConnectionInterface $con = null)
    {
        ...
        if ($criteria->hasUpdateValue(EntryTableMap::COL_ID)) {
