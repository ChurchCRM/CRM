...
|---|---|---|
| `home.html.twig` | `GET /portal` | `pageTitle`, `upcomingEvents`, `hasVisibleCalendars` |
...
More pages arrive with the rest of the epic: profile and family (MP4),
volunteering (MP6), teams (MP7). Each one adds a row to this table.
