...
INSERT INTO `menuconfig_mcf` (`mid`, `name`, `parent`, `ismenu`, `content`, `uri`, `statustext`, `security_grp`, `session_var`, `session_var_in_text`, `session_var_in_uri`, `url_parm_name`, `active`, `sortorder`) VALUES 
(1, 'ROOT', '', 1, 'Main', '', '', 'bAll', NULL, 0, 0, NULL, 1, 0),
(2, 'main', 'root', 1, 'Main', '', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(3, 'logoff', 'main', 0, 'Log Off', 'Default.php?Logoff=True', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(4, 'chgpassword', 'main', 0, 'Change My Password', 'UserPasswordChange.php', '', 'bAll', NULL, 0, 0, NULL, 1, 2),
(5, 'chgsetting', 'main', 0, 'Change My Settings', 'SettingsIndividual.php', '', 'bAll', NULL, 0, 0, NULL, 1, 0),
(6, 'admin', 'root', 1, 'Admin', '', '', 'bAdmin', NULL, 0, 0, NULL, 1, 2),
(7, 'editusers', 'admin', 0, 'Edit Users', 'UserList.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 1),
(8, 'addnewuser', 'admin', 0, 'Add New User', 'UserEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 2),
(9, 'custompersonfld', 'admin', 0, 'Edit Custom Person Fields', 'PersonCustomFieldsEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 3),
(10, 'donationfund', 'admin', 0, 'Edit Donation Funds', 'DonationFundEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 4),
(11, 'dbbackup', 'admin', 0, 'Backup Database', 'BackupDatabase.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 5),
(12, 'cvsimport', 'admin', 0, 'CSV Import', 'CSVImport.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 6),
(13, 'accessreport', 'admin', 0, 'Access report', 'AccessReport.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 7),
(14, 'generalsetting', 'admin', 0, 'Edit General Settings', 'SettingsGeneral.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 8),
(15, 'reportsetting', 'admin', 0, 'Edit Report Settings', 'SettingsReport.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 9),
(16, 'userdefault', 'admin', 0, 'Edit User Default Settings', 'SettingsUser.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 10),
(17, 'envelopmgr', 'admin', 0, 'Envelope Manager', 'ManageEnvelopes.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 11),
(18, 'register', 'admin', 0, 'Please select this option to register ChurchInfo after configuring.', 'Register.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 12),
(19, 'people', 'root', 1, 'People/Families', '', 'People/Families', 'bAll', NULL, 0, 0, NULL, 1, 3),
(20, 'newperson', 'people', 0, 'Add New Person', 'PersonEditor.php', '', 'bAddRecords', NULL, 0, 0, NULL, 1, 1),
(21, 'viewperson', 'people', 0, 'View All Persons', 'SelectList.php?mode=person', '', 'bAll', NULL, 0, 0, NULL, 1, 2),
(22, 'classes', 'people', 0, 'Classification Manager', 'OptionManager.php?mode=classes', '', 'bMenuOptions', NULL, 0, 0, NULL, 1, 3),
(23, 'separator1', 'people', 0, '---------------------------', '', '', 'bAll', NULL, 0, 0, NULL, 1, 4),
(24, 'volunteeropportunity', 'people', 0, 'Edit volunteer opportunities', 'VolunteerOpportunityEditor.php', '', 'bAll', NULL, 0, 0, NULL, 1, 5),
(25, 'separator2', 'people', 0, '---------------------------', '', '', 'bAll', NULL, 0, 0, NULL, 1, 6),
(26, 'newfamily', 'people', 0, 'Add New Family', 'FamilyEditor.php', '', 'bAddRecords', NULL, 0, 0, NULL, 1, 7),
(27, 'viewfamily', 'people', 0, 'View All Families', 'SelectList.php?mode=family', '', 'bAll', NULL, 0, 0, NULL, 1, 8),
(28, 'familygeotools', 'people', 0, 'Family Geographic Utilties', 'GeoPage.php', '', 'bAll', NULL, 0, 0, NULL, 1, 9),
(29, 'familymap', 'people', 0, 'Family Map', 'MapUsingGoogle.php?GroupID=-1', '', 'bAll', NULL, 0, 0, NULL, 1, 10),
(30, 'rolemanager', 'people', 0, 'Family Roles Manager', 'OptionManager.php?mode=famroles', '', 'bMenuOptions', NULL, 0, 0, NULL, 1, 11),
(31, 'events', 'root', 1, 'Events', '', 'Events', 'bAll', NULL, 0, 0, NULL, 1, 4),
(32, 'listevent', 'events', 0, 'List Church Events', 'ListEvents.php', 'List Church Events', 'bAll', NULL, 0, 0, NULL, 1, 1),
(33, 'addevent', 'events', 0, 'Add Church Event', 'EventNames.php', 'Add Church Event', 'bAll', NULL, 0, 0, NULL, 1, 2),
(34, 'eventype', 'events', 0, 'List Event Types', 'EventNames.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 3),
(83, 'eventcheckin', 'events', 0, 'Check-in and Check-out', 'Checkin.php', '', 'bAll', NULL, 0, 0, NULL, 1, 4),
(35, 'deposit', 'root', 1, 'Deposit', '', '', 'bFinance', NULL, 0, 0, NULL, 1, 5),
(36, 'newdeposit', 'deposit', 0, 'Create New Deposit', 'DepositSlipEditor.php?DepositType=Bank', '', 'bFinance', NULL, 0, 0, NULL, 1, 1),
(37, 'viewdeposit', 'deposit', 0, 'View All Deposits', 'FindDepositSlip.php', '', 'bFinance', NULL, 0, 0, NULL, 1, 2),
(38, 'depositreport', 'deposit', 0, 'Deposit Reports', 'FinancialReports.php', '', 'bFinance', NULL, 0, 0, NULL, 1, 3),
(39, 'separator3', 'deposit', 0, '---------------------------', '', '', 'bFinance', NULL, 0, 0, NULL, 1, 4),
(40, 'depositslip', 'deposit', 0, 'Edit Deposit Slip', 'DepositSlipEditor.php', '', 'bFinance', 'iCurrentDeposit', 1, 1, 'DepositSlipID', 1, 5),
(41, 'cart', 'root', 1, 'Cart', '', '', 'bAll', NULL, 0, 0, NULL, 1, 6),
(42, 'viewcart', 'cart', 0, 'List Cart Items', 'CartView.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(43, 'emptycart', 'cart', 0, 'Empty Cart', 'CartView.php?Action=EmptyCart', '', 'bAll', NULL, 0, 0, NULL, 1, 2),
(44, 'carttogroup', 'cart', 0, 'Empty Cart to Group', 'CartToGroup.php', '', 'bManageGroups', NULL, 0, 0, NULL, 1, 3),
(45, 'carttofamily', 'cart', 0, 'Empty Cart to Family', 'CartToFamily.php', '', 'bAddRecords', NULL, 0, 0, NULL, 1, 4),
(46, 'carttoevent', 'cart', 0, 'Empty Cart to Event', 'CartToEvent.php', 'Empty Cart contents to Event', 'bAll', NULL, 0, 0, NULL, 1, 5),
(47, 'report', 'root', 1, 'Data/Reports', '', '', 'bAll', NULL, 0, 0, NULL, 1, 7),
(48, 'cvsexport', 'report', 0, 'CSV Export Records', 'CSVExport.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(49, 'querymenu', 'report', 0, 'Query Menu', 'QueryList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 2),
(50, 'reportmenu', 'report', 0, 'Reports Menu', 'ReportList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 3),
(51, 'groups', 'root', 1, 'Groups', '', '', 'bAll', NULL, 0, 0, NULL, 1, 8),
(52, 'listgroups', 'groups', 0, 'List Groups', 'GroupList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(53, 'newgroup', 'groups', 0, 'Add a New Group', 'GroupEditor.php', '', 'bManageGroups', NULL, 0, 0, NULL, 1, 2),
(54, 'editgroup', 'groups', 0, 'Edit Group Types', 'OptionManager.php?mode=grptypes', '', 'bMenuOptions', NULL, 0, 0, NULL, 1, 3),
(55, 'assigngroup', 'group', 0, 'Group Assignment Helper', 'SelectList.php?mode=groupassign', '', 'bAll', NULL, 0, 0, NULL, 1, 4),
(56, 'properties', 'root', 1, 'Properties', '', '', 'bAll', NULL, 0, 0, NULL, 1, 9),
(57, 'peopleproperty', 'properties', 0, 'People Properties', 'PropertyList.php?Type=p', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(58, 'familyproperty', 'properties', 0, 'Family Properties', 'PropertyList.php?Type=f', '', 'bAll', NULL, 0, 0, NULL, 1, 2),
(59, 'groupproperty', 'properties', 0, 'Group Properties', 'PropertyList.php?Type=g', '', 'bAll', NULL, 0, 0, NULL, 1, 3),
(60, 'propertytype', 'properties', 0, 'Property Types', 'PropertyTypeList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 4),
(64, 'help', 'root', 1, 'Help', '', '', 'bAll', NULL, 0, 0, NULL, 1, 127),
(65, 'about', 'help', 0, 'About ChurchInfo', 'Help.php?page=About', '', 'bAll', NULL, 0, 0, NULL, 1, 1),
(66, 'wiki', 'help', 0, 'Wiki Documentation', 'JumpToWiki.php', '', 'bAll', NULL, 0, 0, NULL, 1, 2),
(67, 'helppeople', 'help', 0, 'People', 'Help.php?page=People', '', 'bAll', NULL, 0, 0, NULL, 1, 3),
(68, 'helpfamily', 'help', 0, 'Families', 'Help.php?page=Family', '', 'bAll', NULL, 0, 0, NULL, 1, 4),
(69, 'helpgeofeature', 'help', 0, 'Geographic features', 'Help.php?page=Geographic', '', 'bAll', NULL, 0, 0, NULL, 1, 5),
(70, 'helpgroups', 'help', 0, 'Groups', 'Help.php?page=Groups', '', 'bAll', NULL, 0, 0, NULL, 1, 6),
(71, 'helpfinance', 'help', 0, 'Finances', 'Help.php?page=Finances', '', 'bAll', NULL, 0, 0, NULL, 1, 7),
(72, 'helpreports', 'help', 0, 'Reports', 'Help.php?page=Reports', '', 'bAll', NULL, 0, 0, NULL, 1, 8),
(73, 'helpadmin', 'help', 0, 'Administration', 'Help.php?page=Admin', '', 'bAll', NULL, 0, 0, NULL, 1, 9),
(74, 'helpcart', 'help', 0, 'Cart', 'Help.php?page=Cart', '', 'bAll', NULL, 0, 0, NULL, 1, 10),
(75, 'helpproperty', 'help', 0, 'Properties', 'Help.php?page=Properties', '', 'bAll', NULL, 0, 0, NULL, 1, 11),
(76, 'helpnotes', 'help', 0, 'Notes', 'Help.php?page=Notes', '', 'bAll', NULL, 0, 0, NULL, 1, 12),
(77, 'helpcustomfields', 'help', 0, 'Custom Fields', 'Help.php?page=Custom', '', 'bAll', NULL, 0, 0, NULL, 1, 13),
(78, 'helpclassification', 'help', 0, 'Classifications', 'Help.php?page=Class', '', 'bAll', NULL, 0, 0, NULL, 1, 14),
(79, 'helpcanvass', 'help', 0, 'Canvass Support', 'Help.php?page=Canvass', '', 'bAll', NULL, 0, 0, NULL, 1, 15),
(80, 'helpevents', 'help', 0, 'Events', 'Help.php?page=Events', '', 'bAll', NULL, 0, 0, NULL, 1, 16),
(81, 'menusetup', 'admin', 0, 'Menu Options', 'MenuSetup.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 13),
(82, 'customfamilyfld', 'admin', 0, 'Edit Custom Family Fields', 'FamilyCustomFieldsEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 3);
...
(6, 15, 'Zip Code', 'per_Zip'),
(7, 15, 'State', 'per_State'),
(8, 15, 'City', 'per_City'),
...
(15, 'SELECT per_ID as AddToCart, CONCAT(''<a href=PersonView.php?PersonID='',per_ID,''>'',per_FirstName,'' '',per_MiddleName,'' '',per_LastName,''</a>'') AS Name, \r\nper_City as City, per_State as State,\r\nper_Zip as ZIP, per_HomePhone as HomePhone, per_Email as Email, per_WorkEmail as WorkEmail\r\nFROM person_per \r\nWHERE ~searchwhat~ LIKE ''%~searchstring~%''', 'Advanced Search', 'Search by any part of Name, City, State, Zip, Home Phone, Email, or Work Email.', 1),
