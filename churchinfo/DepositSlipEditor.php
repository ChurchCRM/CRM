...
<table cellpadding="3" align="center">
	...
	<tr>
		<td align="center">
			...
			<input type="button" class="icButton" value="Download OFX" name="DownloadOFX" onclick="javascript:document.location='Reports/ExportOFX.php?deposit=<?php echo $iDepositSlipID; ?>';">
