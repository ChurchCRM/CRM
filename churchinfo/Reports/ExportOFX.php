...
if ($iCountRows < 1)
{
	...
	$buffer .= "<OFX>";
	$buffer .= "<SIGNONMSGSRSV1><SONRS><STATUS><CODE>0<SEVERITY>INFO</STATUS><DTSERVER>".date("YmdHis.u[O:T]")."<LANGUAGE>ENG<FI><ORG>".$orgName."<FID>12345</FI></SONRS></SIGNONMSGSRSV1>";
	$buffer .= "<BANKMSGSRSV1>".
      "<STMTTRNRS>".
        "<TRNUID>".
        "<STATUS>".
