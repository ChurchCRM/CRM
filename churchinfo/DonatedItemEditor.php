		...
		<table border="0" width="100%" cellspacing="0" cellpadding="4"> <!-- Table for the left side entries -->
			...
			<table cellpadding="3"> <!-- Table for the right side entries -->
				...
				<tr>
					...
					<td><input type="button" class="btn" value="<?= gettext("Go") ?>" name="DonatedItemReplicate" onclick="javascript:document.location='DonatedItemReplicate.php?DonatedItemID=<?php echo $iDonatedItemID;?>&Count='+NumberCopies.value"></td>
				</tr>
