...
<p>
	<a href="NoteDelete.php?Confirmed=Yes&NoteID=<?= $iNoteID ?>"><?= gettext("Yes, delete this record"); ?></a> <?= gettext("(this action cannot be undone)"); ?>
</p>

<p>
	<a href="<?= $sReroute ?>"><?= gettext("No, cancel this deletion"); ?></a>
</p>
