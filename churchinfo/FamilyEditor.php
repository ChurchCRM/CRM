...
if (isset($_POST["FamilySubmit"]) || isset($_POST["FamilySubmitAndAdd"]))
{
	...
	if (!$bErrorFlag)
	{
		...
		{
			$sSQL = "INSERT INTO family_fam (fam_Name, fam_Address1, fam_Address2, fam_City, fam_State, fam_Zip, fam_Country, fam_HomePhone, fam_WorkPhone, fam_CellPhone, fam_Email, fam_WeddingDate, fam_DateEntered, fam_EnteredBy, fam_SendNewsLetter) VALUES ('" . $sName . "','" . $sAddress1 . "','" . $sAddress2 . "','" . $sCity . "','" . $sState . "','" . $sZip . "','" . $sCountry . "','" . $sHomePhone . "','" . $sWorkPhone . "','" . $sCellPhone . "','" . $sEmail . "'," . $dWeddingDate . ",'" . date("YmdHis") . "'," . $_SESSION['iUserID'] . "," . $bSendNewsLetterString . ")";
			$bGetKeyBack = true;
		}
		else
		{
			$sSQL = "UPDATE family_fam SET fam_Name='" . $sName . "', fam_Address1='" . $sAddress1 . "', fam_Address2='" . $sAddress2 . "', fam_City='" . $sCity . "', fam_State='" . $sState . "', fam_Zip='" . $sZip . "', fam_Country='" . $sCountry . "', fam_HomePhone='" . $sHomePhone . "', fam_WorkPhone='" . $sWorkPhone . "', fam_CellPhone='" . $sCellPhone . "', fam_Email='" . $sEmail . "', fam_WeddingDate=" . $dWeddingDate . ", fam_DateLastEdited='" . date("YmdHis") . "', fam_EditedBy = " . $_SESSION['iUserID'] . ", fam_SendNewsLetter = " . $bSendNewsLetterString . " WHERE fam_ID = " . $iFamilyID;
			$bGetKeyBack = false;
		}
