...
?>
        <tr class="<?= $sRowClass; ?>">
          ...
          ?>
              ...
              <input class="SmallText" type="Text" name="newEvtTypeCntLst" value="<?= $cCountList[$row]; ?>" Maxlength="50" id="nETCL" size="30"><br><span class="SmallText"><?= gettext("[enter a list of the attendance counts you want to include with this event. <br> Separate each count_name with a comma. e.g. Members, Visitors, Campus, Children]"); ?></span</td>
