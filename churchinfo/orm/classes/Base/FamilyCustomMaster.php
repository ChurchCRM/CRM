...
use \FamilyCustomMasterQuery as ChildFamilyCustomMasterQuery;
use \Exception;
use \PDO;
use Map\FamilyCustomMasterTableMap;
...
abstract class FamilyCustomMaster implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\FamilyCustomMasterTableMap';
    ...
    /**
     * Initializes internal state of Base\FamilyCustomMaster object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\FamilyCustomMaster The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\FamilyCustomMaster'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\FamilyCustomMaster
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FamilyCustomMaster (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FamilyCustomMaster Clone of current object.
     * @throws PropelException
     */
