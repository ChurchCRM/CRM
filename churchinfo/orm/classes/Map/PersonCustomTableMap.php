...
class PersonCustomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PersonCustomTableMap';
     ...
     */
    const OM_CLASS = '\\PersonCustom';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PersonCustom';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PersonCustom');
        $this->setPackage('');
