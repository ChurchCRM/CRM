...
use \FamilyCustomMaster;
use \FamilyCustomMasterQuery;
...
class FamilyCustomMasterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.FamilyCustomMasterTableMap';
     ...
     */
    const OM_CLASS = '\\FamilyCustomMaster';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FamilyCustomMaster';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FamilyCustomMaster');
        $this->setPackage('');
