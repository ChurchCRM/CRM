...
class FamilyCustomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.FamilyCustomTableMap';
     ...
     */
    const OM_CLASS = '\\FamilyCustom';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FamilyCustom';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FamilyCustom');
        $this->setPackage('');
