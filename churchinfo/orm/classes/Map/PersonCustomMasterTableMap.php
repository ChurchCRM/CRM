...
use \PersonCustomMaster;
use \PersonCustomMasterQuery;
...
class PersonCustomMasterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PersonCustomMasterTableMap';
     ...
     */
    const OM_CLASS = '\\PersonCustomMaster';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PersonCustomMaster';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PersonCustomMaster');
        $this->setPackage('');
