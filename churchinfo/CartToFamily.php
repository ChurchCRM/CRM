...
<table align="center" class="table table-responsive">
	...
	<tr>
		...
		<td class="TextColumnWithBottomBorder"><input type="text" Name="WeddingDate" value="<?= $dWeddingDate; ?>" maxlength="10" id="sel1" size="15"  class="form-control pull-right active"><font color="red"><?= "<BR>" . $sWeddingDateError ?></font></td>
	</tr>
