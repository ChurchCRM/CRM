...
describe("TomSelect dropdownParent:body — remaining call sites (#9488)", () => {
    ...
    it("GroupView .personSearch (Add Member) TomSelect dropdown renders as a direct child of body", () => {
        ...
        // Wait for TomSelect to initialise on the Add Member picker.
        // TomSelect hides the original <select> when it wraps it — that's
        // the reliable signal that init is complete (no retry on .closest()).
