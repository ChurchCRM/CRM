...
-- Date: Sun, 25 Apr 2021 09:46:12 -0400
...
SET autocommit=0;
INSERT INTO `user_usr` VALUES (1,'4bdf3fba58c956fc3991a1fde84929223f968e2853de596e49ae80a91499609b',0,'2021-03-21 17:45:13',37,0,0,0,0,0,0,0,0,1,10,'skin-red',1,1,'2016-01-01',23,2,'Admin','ajGwpy8Pdai22XDUpqjC5Ob04v0eG7EGgb4vz2bD2juT8YDmfM',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL),(3,'598e1814d6b8493f2ad688c634c8b22bb31ac7539b3f79438b91aab2470f574f',0,'2019-09-08 22:04:35',13,0,1,1,1,1,1,0,1,0,10,'skin-green',0,0,'2016-01-01',23,0,'tony.wade@example.com','cjcPihn8wDwVeRIiNnKfpj0HGgCYbcxaD9SaF6BNJKLtVrnGFr',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL),(76,'e57a2fc7529930d46edee4d20ee17e70001fd51a267c11768f9a0dc6dab2fdc1',1,'0000-00-00 00:00:00',2,0,0,0,0,1,0,0,0,0,10,'skin-blue',0,0,'2016-01-01',20,0,'leroy.larson@example.com',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL),(95,'90ad2fca2c2965d51b5acd27c73ddd59244848acb9e299eade7a9758e08afaef',1,'0000-00-00 00:00:00',1,0,1,1,0,0,0,0,0,0,10,'skin-blue',0,0,'2016-01-01',20,0,'judith.matthews@example.com',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL);
...
SET autocommit=0;
INSERT INTO `record2property_r2p` VALUES (4,7,''),(4,8,''),(1,59,'N/A');
...
SET autocommit=0;
INSERT INTO `family_custom` VALUES (10,79,'9999000000','spring',NULL),(21,NULL,NULL,NULL,2);
/*!40000 ALTER TABLE `family_custom` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `family_custom` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `tokens` VALUES ('5fc12cb468e02','verifyFamily',2,'2020-12-04 11:43:32',5);
/*!40000 ALTER TABLE `tokens` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `tokens` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `person_custom` VALUES (50,NULL,NULL,'Law School',NULL),(78,2,NULL,NULL,NULL),(80,NULL,'Fr. Join Smith',NULL,NULL),(104,NULL,NULL,NULL,2),(105,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `person_custom` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `person_custom` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `person2group2role_p2g2r` VALUES (2,9,1),(2,11,1),(4,1,1),(5,1,2),(7,6,1),(8,1,2),(9,1,2),(10,2,2),(11,3,2),(12,5,2),(13,2,2),(16,5,2),(21,6,2),(22,4,2),(24,4,2),(25,5,2),(26,7,1),(26,11,1),(30,3,2),(60,7,1),(63,1,1),(63,8,1),(67,2,1),(79,5,1),(79,9,1),(80,2,2),(80,8,1),(82,2,2),(83,9,1),(93,6,1),(95,8,1),(96,5,2),(100,4,1);
...
-- Dump completed on: Sun, 25 Apr 2021 09:46:14 -0400
