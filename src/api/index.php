...
require __DIR__ . '/routes/ministries/volunteer-status.php';
require __DIR__ . '/routes/ministries/volunteer-scopes.php';
require __DIR__ . '/routes/ministries/volunteer-setup.php';
require __DIR__ . '/routes/ministries/volunteer-schedule.php';
require __DIR__ . '/routes/ministries/volunteer-assignment.php';
require __DIR__ . '/routes/ministries/volunteer-me.php';
require __DIR__ . '/routes/ministries/volunteer-dashboard.php';
require __DIR__ . '/routes/cart.php';
require __DIR__ . '/routes/email.php';
require __DIR__ . '/routes/email-log.php';
