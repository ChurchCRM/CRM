...
abstract class EventQuery extends ModelCriteria
{
     ...
     * $query->filterByTitle('%fooValue%'); // WHERE event_title LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDesc('%fooValue%'); // WHERE event_desc LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByText('%fooValue%'); // WHERE event_text LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByTypeName('%fooValue%'); // WHERE event_typename LIKE '%fooValue%'
     * </code>
     *
