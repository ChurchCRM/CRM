...
abstract class WhyCameQuery extends ModelCriteria
{
     ...
     * $query->filterByJoin('%fooValue%'); // WHERE why_join LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCome('%fooValue%'); // WHERE why_come LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterBySuggest('%fooValue%'); // WHERE why_suggest LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByHearOfUs('%fooValue%'); // WHERE why_hearOfUs LIKE '%fooValue%'
     * </code>
     *
