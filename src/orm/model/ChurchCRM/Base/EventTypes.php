...
abstract class EventTypes implements ActiveRecordInterface
{
    ...
    public function applyDefaultValues()
    {
        ...
        $this->type_defrecurdoy = PropelDateTime::newInstance(NULL, null, 'DateTime');
        $this->type_active = 1;
    }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->type_defrecurdoy && $this->type_defrecurdoy->format('Y-m-d') !== NULL) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 8; // 8 = EventTypesTableMap::NUM_HYDRATE_COLUMNS.
