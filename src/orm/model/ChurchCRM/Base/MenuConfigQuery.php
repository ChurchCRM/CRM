...
abstract class MenuConfigQuery extends ModelCriteria
{
     ...
     * $query->filterByContentEnglish('%fooValue%'); // WHERE content_english LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByStatus('%fooValue%'); // WHERE statustext LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterBySecurityGroup('%fooValue%'); // WHERE security_grp LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterBySessionVar('%fooValue%'); // WHERE session_var LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByURLParmName('%fooValue%'); // WHERE url_parm_name LIKE '%fooValue%'
     * </code>
     *
