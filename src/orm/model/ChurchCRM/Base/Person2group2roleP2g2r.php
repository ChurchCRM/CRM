...
abstract class Person2group2roleP2g2r implements ActiveRecordInterface
{
     ...
     */
    public function setP2g2rPerId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
     ...
     * @return $this|\ChurchCRM\Person2group2roleP2g2r The current object (for fluent API support)
     */
    public function setP2g2rGrpId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
     ...
     * @return $this|\ChurchCRM\Person2group2roleP2g2r The current object (for fluent API support)
     */
    public function setP2g2rRleId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Person2group2roleP2g2rTableMap::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->p2g2r_per_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Person2group2roleP2g2rTableMap::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->p2g2r_grp_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : Person2group2roleP2g2rTableMap::translateFieldName('P2g2rRleId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getP2g2rPerId();
                break;
            case 1:
                return $this->getP2g2rGrpId();
                break;
            case 2:
                return $this->getP2g2rRleId();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getP2g2rPerId(),
            $keys[1] => $this->getP2g2rGrpId(),
            $keys[2] => $this->getP2g2rRleId(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setP2g2rPerId($value);
                break;
            case 1:
                $this->setP2g2rGrpId($value);
                break;
            case 2:
                $this->setP2g2rRleId($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setP2g2rPerId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setP2g2rGrpId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setP2g2rRleId($arr[$keys[2]]);
        }
    }
    ...
    {
        $validPk = null !== $this->getP2g2rPerId() &&
            null !== $this->getP2g2rGrpId();
    ...
    {
        $pks = array();
        $pks[0] = $this->getP2g2rPerId();
        $pks[1] = $this->getP2g2rGrpId();
    ...
    {
        $this->setP2g2rPerId($keys[0]);
        $this->setP2g2rGrpId($keys[1]);
    }
    ...
    {
        return (null === $this->getP2g2rPerId()) && (null === $this->getP2g2rGrpId());
    }
    ...
    {
        $copyObj->setP2g2rPerId($this->getP2g2rPerId());
        $copyObj->setP2g2rGrpId($this->getP2g2rGrpId());
        $copyObj->setP2g2rRleId($this->getP2g2rRleId());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
    ...
    {
        if ($v === null) {
            $this->setP2g2rPerId(0);
        } else {
            $this->setP2g2rPerId($v->getId());
        }
    ...
    {
        if ($v === null) {
            $this->setP2g2rGrpId(0);
        } else {
            $this->setP2g2rGrpId($v->getId());
        }
