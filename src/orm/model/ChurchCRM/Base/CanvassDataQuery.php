...
abstract class CanvassDataQuery extends ModelCriteria
{
     ...
     * $query->filterByPositive('%fooValue%'); // WHERE can_Positive LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCritical('%fooValue%'); // WHERE can_Critical LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByInsightful('%fooValue%'); // WHERE can_Insightful LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByFinancial('%fooValue%'); // WHERE can_Financial LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterBySuggestion('%fooValue%'); // WHERE can_Suggestion LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByWhyNotInterested('%fooValue%'); // WHERE can_WhyNotInterested LIKE '%fooValue%'
     * </code>
     *
