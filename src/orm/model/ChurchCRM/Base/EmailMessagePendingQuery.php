...
abstract class EmailMessagePendingQuery extends ModelCriteria
{
     ...
     * $query->filterBySubject('%fooValue%'); // WHERE emp_subject LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByMessage('%fooValue%'); // WHERE emp_message LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByAttachName('%fooValue%'); // WHERE emp_attach_name LIKE '%fooValue%'
     * </code>
     *
