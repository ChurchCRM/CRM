...
abstract class DonatedItemQuery extends ModelCriteria
{
     ...
     * $query->filterByItem('%fooValue%'); // WHERE di_item LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByTitle('%fooValue%'); // WHERE di_title LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDescription('%fooValue%'); // WHERE di_description LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByPicture('%fooValue%'); // WHERE di_picture LIKE '%fooValue%'
     * </code>
     *
