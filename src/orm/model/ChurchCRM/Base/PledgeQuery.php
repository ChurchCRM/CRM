...
abstract class PledgeQuery extends ModelCriteria
{
     ...
     * $query->filterBySchedule('%fooValue%'); // WHERE plg_schedule LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByMethod('%fooValue%'); // WHERE plg_method LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByComment('%fooValue%'); // WHERE plg_comment LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByPledgeorpayment('%fooValue%'); // WHERE plg_PledgeOrPayment LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByScanstring('%fooValue%'); // WHERE plg_scanString LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByGroupkey('%fooValue%'); // WHERE plg_GroupKey LIKE '%fooValue%'
     * </code>
     *
