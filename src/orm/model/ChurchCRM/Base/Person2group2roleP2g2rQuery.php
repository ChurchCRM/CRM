 ...
 *
 *
 * @method     ChildPerson2group2roleP2g2rQuery orderByP2g2rPerId($order = Criteria::ASC) Order by the p2g2r_per_ID column
 * @method     ChildPerson2group2roleP2g2rQuery orderByP2g2rGrpId($order = Criteria::ASC) Order by the p2g2r_grp_ID column
 * @method     ChildPerson2group2roleP2g2rQuery orderByP2g2rRleId($order = Criteria::ASC) Order by the p2g2r_rle_ID column
 *
 * @method     ChildPerson2group2roleP2g2rQuery groupByP2g2rPerId() Group by the p2g2r_per_ID column
 * @method     ChildPerson2group2roleP2g2rQuery groupByP2g2rGrpId() Group by the p2g2r_grp_ID column
 * @method     ChildPerson2group2roleP2g2rQuery groupByP2g2rRleId() Group by the p2g2r_rle_ID column
 *
 ...
 *
 * @method     ChildPerson2group2roleP2g2r findOneByP2g2rPerId(int $p2g2r_per_ID) Return the first ChildPerson2group2roleP2g2r filtered by the p2g2r_per_ID column
 * @method     ChildPerson2group2roleP2g2r findOneByP2g2rGrpId(int $p2g2r_grp_ID) Return the first ChildPerson2group2roleP2g2r filtered by the p2g2r_grp_ID column
 * @method     ChildPerson2group2roleP2g2r findOneByP2g2rRleId(int $p2g2r_rle_ID) Return the first ChildPerson2group2roleP2g2r filtered by the p2g2r_rle_ID column *
 ...
 *
 * @method     ChildPerson2group2roleP2g2r requireOneByP2g2rPerId(int $p2g2r_per_ID) Return the first ChildPerson2group2roleP2g2r filtered by the p2g2r_per_ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPerson2group2roleP2g2r requireOneByP2g2rGrpId(int $p2g2r_grp_ID) Return the first ChildPerson2group2roleP2g2r filtered by the p2g2r_grp_ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPerson2group2roleP2g2r requireOneByP2g2rRleId(int $p2g2r_rle_ID) Return the first ChildPerson2group2roleP2g2r filtered by the p2g2r_rle_ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPerson2group2roleP2g2r[]|ObjectCollection findByP2g2rPerId(int $p2g2r_per_ID) Return ChildPerson2group2roleP2g2r objects filtered by the p2g2r_per_ID column
 * @method     ChildPerson2group2roleP2g2r[]|ObjectCollection findByP2g2rGrpId(int $p2g2r_grp_ID) Return ChildPerson2group2roleP2g2r objects filtered by the p2g2r_grp_ID column
 * @method     ChildPerson2group2roleP2g2r[]|ObjectCollection findByP2g2rRleId(int $p2g2r_rle_ID) Return ChildPerson2group2roleP2g2r objects filtered by the p2g2r_rle_ID column
...
abstract class Person2group2roleP2g2rQuery extends ModelCriteria
{
     ...
     * Example usage:
     * <code>
     * $query->filterByP2g2rPerId(1234); // WHERE p2g2r_per_ID = 1234
     * $query->filterByP2g2rPerId(array(12, 34)); // WHERE p2g2r_per_ID IN (12, 34)
     * $query->filterByP2g2rPerId(array('min' => 12)); // WHERE p2g2r_per_ID > 12
     * </code>
     *
     * @see       filterByPerson()
     *
     * @param     mixed $p2g2rPerId The value to use as filter.
     ...
     * @return $this|ChildPerson2group2roleP2g2rQuery The current query, for fluid interface
     */
    public function filterByP2g2rPerId($p2g2rPerId = null, $comparison = null)
    {
        if (is_array($p2g2rPerId)) {
            $useMinMax = false;
            if (isset($p2g2rPerId['min'])) {
                $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID, $p2g2rPerId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($p2g2rPerId['max'])) {
                $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID, $p2g2rPerId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID, $p2g2rPerId, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByP2g2rGrpId(1234); // WHERE p2g2r_grp_ID = 1234
     * $query->filterByP2g2rGrpId(array(12, 34)); // WHERE p2g2r_grp_ID IN (12, 34)
     * $query->filterByP2g2rGrpId(array('min' => 12)); // WHERE p2g2r_grp_ID > 12
     * </code>
     *
     * @see       filterByGroup()
     *
     * @param     mixed $p2g2rGrpId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildPerson2group2roleP2g2rQuery The current query, for fluid interface
     */
    public function filterByP2g2rGrpId($p2g2rGrpId = null, $comparison = null)
    {
        if (is_array($p2g2rGrpId)) {
            $useMinMax = false;
            if (isset($p2g2rGrpId['min'])) {
                $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID, $p2g2rGrpId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($p2g2rGrpId['max'])) {
                $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID, $p2g2rGrpId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID, $p2g2rGrpId, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByP2g2rRleId(1234); // WHERE p2g2r_rle_ID = 1234
     * $query->filterByP2g2rRleId(array(12, 34)); // WHERE p2g2r_rle_ID IN (12, 34)
     * $query->filterByP2g2rRleId(array('min' => 12)); // WHERE p2g2r_rle_ID > 12
     * </code>
     *
     * @param     mixed $p2g2rRleId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildPerson2group2roleP2g2rQuery The current query, for fluid interface
     */
    public function filterByP2g2rRleId($p2g2rRleId = null, $comparison = null)
    {
        if (is_array($p2g2rRleId)) {
            $useMinMax = false;
            if (isset($p2g2rRleId['min'])) {
                $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_RLE_ID, $p2g2rRleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($p2g2rRleId['max'])) {
                $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_RLE_ID, $p2g2rRleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(Person2group2roleP2g2rTableMap::COL_P2G2R_RLE_ID, $p2g2rRleId, $comparison);
    }
    ...
    public function prune($person2group2roleP2g2r = null)
    {
        if ($person2group2roleP2g2r) {
            $this->addCond('pruneCond0', $this->getAliasedColName(Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID), $person2group2roleP2g2r->getP2g2rPerId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(Person2group2roleP2g2rTableMap::COL_P2G2R_GRP_ID), $person2group2roleP2g2r->getP2g2rGrpId(), Criteria::NOT_EQUAL);
