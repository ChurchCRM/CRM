...
abstract class UserConfigQuery extends ModelCriteria
{
     ...
     * $query->filterByName('%fooValue%'); // WHERE ucfg_name LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByValue('%fooValue%'); // WHERE ucfg_value LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByType('%fooValue%'); // WHERE ucfg_type LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByTooltip('%fooValue%'); // WHERE ucfg_tooltip LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByPermission('%fooValue%'); // WHERE ucfg_permission LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCat('%fooValue%'); // WHERE ucfg_cat LIKE '%fooValue%'
     * </code>
     *
