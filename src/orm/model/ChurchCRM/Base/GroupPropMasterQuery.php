...
abstract class GroupPropMasterQuery extends ModelCriteria
{
     ...
     * $query->filterByField('%fooValue%'); // WHERE prop_Field LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByName('%fooValue%'); // WHERE prop_Name LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDescription('%fooValue%'); // WHERE prop_Description LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByPersonDisplay('%fooValue%'); // WHERE prop_PersonDisplay LIKE '%fooValue%'
     * </code>
     *
