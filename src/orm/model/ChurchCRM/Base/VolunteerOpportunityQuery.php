...
abstract class VolunteerOpportunityQuery extends ModelCriteria
{
     ...
     * $query->filterByActive('%fooValue%'); // WHERE vol_Active LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByName('%fooValue%'); // WHERE vol_Name LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDescription('%fooValue%'); // WHERE vol_Description LIKE '%fooValue%'
     * </code>
     *
