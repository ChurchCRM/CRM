...
abstract class QueryParametersQuery extends ModelCriteria
{
     ...
     * $query->filterByOptionSQL('%fooValue%'); // WHERE qrp_OptionSQL LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByName('%fooValue%'); // WHERE qrp_Name LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDescription('%fooValue%'); // WHERE qrp_Description LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByAlias('%fooValue%'); // WHERE qrp_Alias LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDefault('%fooValue%'); // WHERE qrp_Default LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByValidation('%fooValue%'); // WHERE qrp_Validation LIKE '%fooValue%'
     * </code>
     *
