...
abstract class AutoPaymentQuery extends ModelCriteria
{
     ...
     * $query->filterByFirstName('%fooValue%'); // WHERE aut_FirstName LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByLastName('%fooValue%'); // WHERE aut_LastName LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByAddress1('%fooValue%'); // WHERE aut_Address1 LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByAddress2('%fooValue%'); // WHERE aut_Address2 LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCity('%fooValue%'); // WHERE aut_City LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByState('%fooValue%'); // WHERE aut_State LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByZip('%fooValue%'); // WHERE aut_Zip LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCountry('%fooValue%'); // WHERE aut_Country LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByPhone('%fooValue%'); // WHERE aut_Phone LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByEmail('%fooValue%'); // WHERE aut_Email LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCreditCard('%fooValue%'); // WHERE aut_CreditCard LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByExpMonth('%fooValue%'); // WHERE aut_ExpMonth LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByExpYear('%fooValue%'); // WHERE aut_ExpYear LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByBankName('%fooValue%'); // WHERE aut_BankName LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByRoute('%fooValue%'); // WHERE aut_Route LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByAccount('%fooValue%'); // WHERE aut_Account LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCreditcardvanco('%fooValue%'); // WHERE aut_CreditCardVanco LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByAccountVanco('%fooValue%'); // WHERE aut_AccountVanco LIKE '%fooValue%'
     * </code>
     *
