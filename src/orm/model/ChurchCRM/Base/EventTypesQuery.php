...
abstract class EventTypesQuery extends ModelCriteria
{
     ...
     * $query->filterByName('%fooValue%'); // WHERE type_name LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDefRecurType('%fooValue%'); // WHERE type_defrecurtype LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDefRecurDOW('%fooValue%'); // WHERE type_defrecurDOW LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDefRecurDOM('%fooValue%'); // WHERE type_defrecurDOM LIKE '%fooValue%'
     * </code>
     *
