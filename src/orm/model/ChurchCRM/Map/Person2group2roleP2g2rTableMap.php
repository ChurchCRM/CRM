...
class Person2group2roleP2g2rTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('P2g2rPerId', 'P2g2rGrpId', 'P2g2rRleId', ),
        self::TYPE_CAMELNAME     => array('p2g2rPerId', 'p2g2rGrpId', 'p2g2rRleId', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('P2g2rPerId' => 0, 'P2g2rGrpId' => 1, 'P2g2rRleId' => 2, ),
        self::TYPE_CAMELNAME     => array('p2g2rPerId' => 0, 'p2g2rGrpId' => 1, 'p2g2rRleId' => 2, ),
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addForeignPrimaryKey('p2g2r_per_ID', 'P2g2rPerId', 'SMALLINT' , 'person_per', 'per_ID', true, 8, 0);
        $this->addForeignPrimaryKey('p2g2r_grp_ID', 'P2g2rGrpId', 'SMALLINT' , 'group_grp', 'grp_ID', true, 8, 0);
        $this->addColumn('p2g2r_rle_ID', 'P2g2rRleId', 'SMALLINT', true, 8, 0);
    } // initialize()
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getP2g2rPerId() || is_scalar($obj->getP2g2rPerId()) || is_callable([$obj->getP2g2rPerId(), '__toString']) ? (string) $obj->getP2g2rPerId() : $obj->getP2g2rPerId()), (null === $obj->getP2g2rGrpId() || is_scalar($obj->getP2g2rGrpId()) || is_callable([$obj->getP2g2rGrpId(), '__toString']) ? (string) $obj->getP2g2rGrpId() : $obj->getP2g2rGrpId())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ChurchCRM\Person2group2roleP2g2r) {
                $key = serialize([(null === $value->getP2g2rPerId() || is_scalar($value->getP2g2rPerId()) || is_callable([$value->getP2g2rPerId(), '__toString']) ? (string) $value->getP2g2rPerId() : $value->getP2g2rPerId()), (null === $value->getP2g2rGrpId() || is_scalar($value->getP2g2rGrpId()) || is_callable([$value->getP2g2rGrpId(), '__toString']) ? (string) $value->getP2g2rGrpId() : $value->getP2g2rGrpId())]);
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize([(null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)]), (null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)])]);
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        $pks[] = (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('P2g2rPerId', TableMap::TYPE_PHPNAME, $indexType)
        ];
        $pks[] = (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 1 + $offset
                : self::translateFieldName('P2g2rGrpId', TableMap::TYPE_PHPNAME, $indexType)
        ];
