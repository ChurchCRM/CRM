...
if (isset($_POST['Clear'])) {
    if (isset($_POST['chkClear'])) {
        ...
        (1, NULL, 'ChurchCRM', NULL, 'Admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0000, NULL, 0, 0, 0, 0, NULL, NULL, '2004-08-25 18:00:00', 1, 0, NULL, 0,NULL);";
        RunQuery($sSQL);
