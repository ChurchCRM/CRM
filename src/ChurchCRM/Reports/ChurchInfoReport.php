...
/**
 * @deprecated since ChurchCRM 7.1 — use {@see \ChurchCRM\Service\PdfRenderer\MpdfRenderer} with
 *             a Twig template in src/templates/reports/ instead.  This class will be removed once
 *             all individual report scripts have been migrated to the new mPDF-based framework.
 */
