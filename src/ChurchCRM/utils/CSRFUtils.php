...
class CSRFUtils
{
    ...
    public static function validateToken(string $token, string $formId = 'default'): bool
    {
        ...
        // Note: The form templates regenerate a new token when re-rendered,
        // so if validation fails and the form is shown again with errors,
        // a fresh token will be automatically generated by the template.
        if ($isValid) {
            unset($_SESSION[self::SESSION_KEY][$formId]);
        }
