...
class   SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'sPaperFormat'                         => new ConfigItem(20235, 'sPaperFormat', 'choice', 'Letter', gettext('Paper format used for PDF reports (e.g. Letter, A4, Legal)'), '', json_encode(['Choices' => ['A3', 'A4', 'A5', 'Letter', 'Legal']], JSON_THROW_ON_ERROR)),
    ...
    private static function buildCategories(): array
    {
        return [
            ...
            gettext('Report Settings')    => ['sQBDTSettings', 'leftX', 'incrementY', 'sTaxReport1', 'sTaxReport2', 'sTaxReport3', 'sTaxSigner', 'sReminder1', 'sReminderSigner', 'sReminderNoPledge', 'sReminderNoPayments', 'sConfirm1', 'sConfirm2', 'sConfirm3', 'sConfirm4', 'sConfirm5', 'sConfirm6', 'sDear', 'sConfirmSincerely', 'sConfirmSigner', 'sPledgeSummary1', 'sPledgeSummary2', 'sDirectoryDisclaimer1', 'sDirectoryDisclaimer2', 'bDirLetterHead', 'sZeroGivers', 'sZeroGivers2', 'sZeroGivers3', 'iPDFOutputType', 'sPaperFormat'],
