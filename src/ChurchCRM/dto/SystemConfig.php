...
class SystemConfig
{
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('User setup') => ["iMinPasswordLength","iMinPasswordChange","iMaxFailedLogins","iSessionTimeout","aDisallowedPasswords","bEnableLostPassword","bEnable2FA","bRequire2FA"],
