...
class   SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'sPaperFormat'                         => new ConfigItem('sPaperFormat', 'choice', 'Letter', gettext('Paper format used for PDF reports (e.g. Letter, A4, Legal)'), '', json_encode(['Choices' => ['A3', 'A4', 'A5', 'Letter', 'Legal']], JSON_THROW_ON_ERROR)),
