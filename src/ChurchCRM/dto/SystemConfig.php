...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "bSearchIncludeAdresses" => new ConfigItem(2026, "bSearchIncludeAdresses", "boolean", "1", gettext("Search Payments")),
        ...
        "bSearchIncludeAdressesNumbers" => new ConfigItem(20233, "bSearchIncludeAdressesNumbers", "text", "15", gettext("Search Payments"))
