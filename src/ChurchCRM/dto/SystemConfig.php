...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "bPHPMailerSMTPSecure" => new ConfigItem(2046, "bPHPMailerSMTPSecure", "choice", " ", gettext("Set the encryption system to use - ssl (deprecated) or tls"),"",'{"Choices":["None: ","TLS:tls","SSL:ssl"]}')
    );
  }
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('Email Setup')  => ["sSMTPHost","bSMTPAuth","sSMTPUser","sSMTPPass", "iSMTPTimeout","sToEmailAddress", "bPHPMailerAutoTLS","bPHPMailerSMTPSecure"],
