...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "sChurchTaxID" => new ConfigItem(1051, "sChurchTaxID", "text", "", gettext("Charitable Registration Number")),"sChurchTaxID" => new ConfigItem(1051, "sChurchTaxID", "text", "", gettext("Charitable Registration Number")),
        "sTaxSignerImg" => new ConfigItem(1052, "sTaxSignerImg", "text", "", gettext("Tax Report signer image path")),
  ...
  {
    return array (
      gettext('Church Information') =>["sChurchName","sChurchAddress","sChurchCity","sChurchState","sChurchZip","sChurchCountry","sChurchPhone","sChurchEmail","sHomeAreaCode","sChurchTaxID","sTimeZone","iChurchLatitude","iChurchLongitude", "sChurchWebSite","sChurchFB", "sChurchTwitter"],
