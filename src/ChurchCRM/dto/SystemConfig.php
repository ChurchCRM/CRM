...
class   SystemConfig
{
    ...
    private static function buildCategories(): array
    {
        return [
            ...
            gettext('Integration')        => ['sMailChimpApiKey', 'sGoogleTrackingID', 'bEnableGravatarPhotos', 'sVonageAPIKey', 'sVonageAPISecret', 'sVonageFromNumber', 'sOLPURL', 'sOLPUserName', 'sOLPPassword'],
