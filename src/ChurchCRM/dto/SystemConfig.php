...
class   SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'iMinPasswordLength'                   => new ConfigItem(13, 'iMinPasswordLength', 'number', '8', gettext('Minimum length a user may set their password to')),
            ...
            'bEnforceCSP'                          => new ConfigItem(20234, 'bEnforceCSP', 'boolean', '1', gettext('Enforce Content Security Policy (CSP) to help protect against cross-site scripting. When disabled, CSP violations are only reported.')),
