...
class GroupQuery extends BaseGroupQuery
{
    public function preSelect(ConnectionInterface $con): void
    {
        ...
        $this->addAsColumn('COUNT(' . Person2group2roleP2g2rTableMap::COL_P2G2R_PER_ID . ')', 'memberCount');
        ...
        // addForeignValueCondition expects table name and column name separately (not the full COL_ constant)
        ...
        $this->addAsColumn(ListOptionTableMap::COL_LST_OPTIONNAME, 'groupType');
