...
/**
 * Volunteer Management v2 (#9706): load a volunteer schedule and decide whether the caller may
 * touch THIS one.
 *
 ...
 */
class VolunteerScheduleMiddleware extends AbstractEntityMiddleware
{
    ...
    {
        return VolunteerScheduleQuery::create()->findPk((int) $id);
    }

    protected function getNotFoundMessage(): string
    {
        return gettext('Schedule not found');
    }
    ...
    protected function postEntityLoad(ServerRequestInterface $request, mixed $entity): ?ResponseInterface
    {
        ...
        if (!$authz->canManageSchedule($currentUser, $entity)) {
            return SlimUtils::renderErrorJSON(new Response(), gettext('Not authorized for this schedule'), [], 403);
        }
