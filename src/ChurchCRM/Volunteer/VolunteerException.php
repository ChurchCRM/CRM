 ...
 * drift). `VolunteerMinistryService` (#9707/#9715) and `VolunteerAssignmentService`
 ...
 */
class VolunteerException extends \RuntimeException
{
     ...
     * one expression: `throw VolunteerException::conflict($msg)->withExtra([...])`.
     *
