...
class Countries
{
    ...
    private static function initializeCountries() {
      self::$countries = array(
        ...
        'AT' => new Country('AT','Austria (Österreich)',''),
        ...
        'BE' => new Country('BE','Belgium (België)',''),
        ...
        'BA' => new Country('BA','Bosnia and Herzegovina (Босна и Херцеговина)',''),
        'BW' => new Country('BW','Botswana',''),
        'BV' => new Country('BV','Bouvet Island',''),
        'BR' => new Country('BR','Brazil (Brasil)',''),
        ...
        'HR' => new Country('HR','Croatia (Hrvatska)',''),
        'CU' => new Country('CU','Cuba',''),
        'CW' => new Country('CW','Curaçao',''),
        'CY' => new Country('CY','Cyprus (Κύπρος)',''),
        'CZ' => new Country('CZ','Czech Republic (Česká republika)',''),
        'DK' => new Country('DK','Denmark (Danmark)',''),
        ...
        'EE' => new Country('EE','Estonia (Eesti)',''),
        ...
        'FI' => new Country('FI','Finland (Suomi)',''),
        ...
        'DE' => new Country('DE','Germany (Deutschland)',''),
        'GH' => new Country('GH','Ghana (Gaana)',''),
        'GI' => new Country('GI','Gibraltar',''),
        'GR' => new Country('GR','Greece (Ελλάδα)',''),
        ...
        'HU' => new Country('HU','Hungary (Magyarország)',''),
        ...
        'IT' => new Country('IT','Italy (Italia)',''),
        'JM' => new Country('JM','Jamaica',''),
        'JP' => new Country('JP','Japan (日本)',''),
        ...
        'LT' => new Country('LT','Lithuania (Lietuva)',''),
        ...
        'NO' => new Country('NO','Norway (Norge)',''),
        ...
        'SK' => new Country('SK','Slovakia (Slovensko)',''),
        'SI' => new Country('SI','Slovenia (Slovenija)',''),
        ...
        'ES' => new Country('ES','Spain (España)',''),
        ...
        'SE' => new Country('SE','Sweden (Sverige)',''),
        'CH' => new Country('CH','Switzerland (Schweiz)',''),
        ...
        'UA' => new Country('UA','Ukraine (Україна)',''),
