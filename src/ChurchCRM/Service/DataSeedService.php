...
class DataSeedService
{
    ...
    public function generateFamilies($families)
    {
    ...
    public function generateSundaySchoolClasses()
    {
        requireUserGroupMembership('bAdmin');
        $classNames = ['Angels class', 'Class 1-3', 'Class 4-5', 'Class 6-7', 'High School Class', 'Youth Meeting'];
    ...
    public function generateFundRaisers()
    {
        requireUserGroupMembership('bAdmin');
    ...
    public function getStateAbb($state)
    {
        $states = [
      'Alabama'       => 'AL',
      'Alaska'        => 'AK',
