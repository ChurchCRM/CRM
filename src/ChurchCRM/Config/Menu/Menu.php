...
class Menu
{
    ...
    private static function getPeopleMenu(bool $isAdmin, bool $isMenuOptions, bool $isAddRecordsEnabled): MenuItem
    {
        ...
        if ($isAdmin || $isMenuOptions) {
            ...
            $adminMenu->addSubMenu(new MenuItem(gettext('Family Roles'), 'admin/system/options?mode=famroles', $isMenuOptions, 'fa-people-roof'));
            ...
            $adminMenu->addSubMenu(new MenuItem(gettext('Person Classifications'), 'admin/system/options?mode=classes', $isMenuOptions, 'fa-tags'));
    ...
    private static function getGroupMenu(bool $isAdmin, bool $isMenuOptions, bool $isManageGroups): MenuItem
    {
        ...
        if ($canSeeGroupAdmin) {
            ...
            $adminMenu->addSubMenu(new MenuItem(gettext('Group Types'), 'admin/system/options?mode=grptypes', true, 'fa-tags'));
