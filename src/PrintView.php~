...
echo '<b><font size="7">'.$per_FirstName.' '.$per_MiddleName.' '.$per_LastName.'</font></b><br>';
echo '<font size="3">';
if ($sAddress1 != '') {
    echo $sAddress1.' - ';
}
...
<tr>
	...
	<td width="33%" valign="top" align="left">
		<table cellspacing="1" cellpadding="4">
			...
			<tr>
				<td class="LabelColumn"><?= gettext('Tornou-se Membro em') ?>:</td>
				<td width="<?= $iTableSpacerWidth ?>"></td>
...
?>
<BR>
<b><?= gettext('Sociedades Internas') ?>:</b>
...
?>
<BR>
<b><?= gettext('Características Especiais') ?>:</b>
