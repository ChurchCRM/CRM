...
// Format the phone numbers
    ...
    <div class="col-lg-3 col-md-4 col-sm-4">
      <div class="box box-primary">
        <div class="box-body">
          ...
          <h3 class="profile-username text-center"><?php if ($lang == "fr_FR")
          																							echo gettext("The"). " ". gettext("Family") . " $fam_Name " ;
          																						else 	
          																							echo gettext("The") . " $fam_Name " . gettext("Family") ?></h3>
          																					</h3>
          <?php if ($bOkToEdit) { ?>
                  ...
                  <table cellpadding="5" cellspacing="0" width="100%">
                    ...
                    while ($aRow = mysql_fetch_array($rsAutoPayments)) {
                      ...
                      <tr class="<?= $sRowClass ?>">
                        ...
                        <td>
                          <?= localizeDate($aut_NextPayDate,"fr") ?>&nbsp;
                        </td>
                        <td>
                          <?= $aut_Amount ?>&nbsp;
                        </td>
  ...
  <div class="modal fade" id="confirm-email-pdf" tabindex="-1" role="dialog" aria-labelledby="delete-Image-label" aria-hidden="true">
	...
	<script src="<?= $sRootPath ?>/skin/adminlte/plugins/datepicker/locales/bootstrap-datepicker.fr.js" type="text/javascript" charset="UTF-8"></script>
	
  <script>
    $("#ShowSinceDate").datepicker({format: '<?= gettext("yyyy-mm-dd")?>',language :'<?= substr(getTranslationLanguage(),0,2)?>'});
  </script>
<?php } else { ?>
