...
<div class="error-page">
    ...
    <div class="error-content">
        ...
        <p>
            <?= gettext("We could not find the survey(s) you were looking for.") ?>
            <?= gettext("Meanwhile, you may")?> <a href="<?= SystemURLs::getRootPath() ?>/surveys/dashboard"> <?= gettext("return to survey dashboard") ?></a>
        </p>
    </div>
</div>
