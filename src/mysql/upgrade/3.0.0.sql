...
AFTER `event_typename`;
ALTER TABLE events_event
ADD COLUMN primary_contact_person_id INT DEFAULT NULL
AFTER `location_id`;
ALTER TABLE events_event
ADD COLUMN secondary_contact_person_id INT DEFAULT NULL
AFTER `primary_contact_person_id`;
ALTER TABLE events_event
ADD COLUMN event_url text DEFAULT NULL
AFTER `secondary_contact_person_id`;
