...
<div class="btn-group pull-right clearfix">
  <a class="btn btn-success" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i><?= gettext("Compose Message") ?></a>
  <a class="btn btn-info" href="../GroupView.php?GroupID=<?= $iGroupId ?>"><i class="fa fa-eye-slash"></i><?= gettext("LegacyView") ?> </a>
</div>
