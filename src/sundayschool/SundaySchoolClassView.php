      ...
      <div class="col-sm-2">
        ...
        <div class="box box-info text-center user-profile-2">
          <div class="user-profile-inner">
            ...
            <img src="<?= SystemURLs::getRootPath(); ?>/api/persons/<?= $teacher['per_ID'] ?>/thumbnail" class="img-circle profile-avatar"
  ...
  <div class="box-body table-responsive">
    <table id="sundayschool" class="table table-striped table-bordered data-table" cellspacing="0" width="100%">
      ...
      foreach ($thisClassChildren as $child) {
          ...
          echo '<tr>';
          echo "<td><img src='".SystemURLs::getRootPath().'/api/persons/'.$child['kidId']."/thumbnail' hight='30' width='30' > <a href='../PersonView.php?PersonID=".$child['kidId']."'>".$child['firstName'].', '.$child['LastName'].'</a></td>';
