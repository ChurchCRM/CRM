<?php
// Legacy redirect shim — migrated to /fundraiser/{fundraiserId}/reports/catalog
...
if ($iCurrentFundraiser > 0) {
    RedirectUtils::absoluteRedirect(rtrim(\ChurchCRM\dto\SystemURLs::getRootPath(), '/') . '/fundraiser/' . $iCurrentFundraiser . '/reports/catalog');
} else {
