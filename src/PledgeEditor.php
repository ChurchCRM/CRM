    ...
    if (!$bErrorFlag && !$dep_Closed) {
        ...
        if (isset($_POST['PledgeSubmit'])) {
            ...
            if ($linkBack != '') {
               ...
               MiscUtils::Redirect('PledgeEditor.php?PledgeOrPayment='.$PledgeOrPayment.'&GroupKey='.$sGroupKey.'&linkBack=', $linkBack);
            }
        } elseif (isset($_POST['PledgeSubmitAndAdd'])) {
            //Reload to editor to add another record
           MiscUtils::Redirect("PledgeEditor.php?CurrentDeposit=$iCurrentDeposit&PledgeOrPayment=".$PledgeOrPayment.'&linkBack=', $linkBack);
        }
    } // end if !$bErrorFlag
