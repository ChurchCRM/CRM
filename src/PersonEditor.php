                ...
                <div class="form-group col-md-3 col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="MembershipDate" class="form-control date-picker"
                               value="<?= date("d-m-Y", strtotime($dMembershipDate)) ?>" maxlength="10" id="sel1" size="11"
                               placeholder="<?= SystemConfig::getValue("sDateFormatLong") ?>">
                ...
                <div class="form-group col-md-3 col-lg-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="FriendDate" class="form-control date-picker"
                           value="<?= date("d-m-Y", strtotime($dFriendDate)) ?>" maxlength="10" id="sel2" size="10"
                           placeholder="<?= SystemConfig::getValue("sDateFormatLong") ?>">
