                ...
                <div class="form-group col-md-3 col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="MembershipDate" class="form-control date-picker"
                               value="<?= ((strtotime($dMembershipDate) != "")?date(SystemConfig::getValue("sDateFormatLong"), strtotime($dMembershipDate)):strtotime($data)) ?>" maxlength="10" id="sel1" size="11"
                ...
                <div class="form-group col-md-3 col-lg-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="FriendDate" class="form-control date-picker"
                           value="<?= ((strtotime($dFriendDate) != "")?date(SystemConfig::getValue("sDateFormatLong"), strtotime($dMembershipDate)):strtotime($dFriendDate)) ?>" maxlength="10" id="sel2" size="10"
                           placeholder="<?= SystemConfig::getValue("sDatePickerPlaceHolder") ?>">
