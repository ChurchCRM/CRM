    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-auto">
                            <?php // No avatar-loader/lightbox hooks here: this page is token-authenticated
                                  // (no user session), so the /api/family/{id}/avatar fetch would 403.
                                  // The photo is rendered inline as base64 below. ?>
