...
$("document").ready(function()
{
  ...
  $(".groupSpecificProperties").click(function(e)
  {
    ...
    if(groupPropertyAction == "enableGroupProps")
    {
      ...
      $("#gsproperties-label").text("<?= _('Confirm Enable Group Specific Properties') ?>");
      $("#groupSpecificPropertiesModal .modal-body span").text("<?= _('This will create a group-specific properties table for this group.  You should then add needed properties with the Group-Specific Properties Form Editor.') ?>");
      $("#setgroupSpecificProperties").text("<?= _('Enable Group Specific Properties') ?>");
      $("#setgroupSpecificProperties").data("action",1);
    }
    else
    {
      $("#groupSpecificPropertiesModal").modal("show");
      $("#gsproperties-label").text("<?= _('Confirm Disable Group Specific Properties') ?>");
      $("#groupSpecificPropertiesModal .modal-body span").text("<?= _('Are you sure you want to remove the group-specific person properties?  All group member properties data will be lost!') ?>");
      $("#setgroupSpecificProperties").text("<?= _('Disable Group Specific Properties') ?>");
