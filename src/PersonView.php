...
<div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-9">
    ...
    if ($_SESSION['bDeleteRecords']) {
        ?>
        <a class="btn btn-app bg-maroon" class="delete-person" data-person_name="<?= $person->getFullName()?>" data-person_id="<?= $iPersonID ?>"><i class="fa fa-trash-o"></i> <?= gettext("Delete this Record") ?></a>
      <?php
    }
    if ($_SESSION['bAdmin']) {
        if (!$person->isUser()) {
