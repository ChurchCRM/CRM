    ...
    <div class="row" id="localization">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-body-secondary mb-3">
                        <?= gettext('PHP date format tokens are used (e.g. Y = 4-digit year, m = month, d = day). Leave blank to use the system default.') ?>
                    </p>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sDateFormatLong']) ?>"
                                   maxlength="50"
                                   placeholder="m/d/Y">
                            <small class="form-text text-body-secondary">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sDateFormatNoYear']) ?>"
                                   maxlength="50"
                                   placeholder="m/d">
                            <small class="form-text text-body-secondary">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sDateTimeFormat']) ?>"
                                   maxlength="50"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sDateFilenameFormat']) ?>"
                                   maxlength="50"
                                   placeholder="Ymd-Gis">
                            <small class="form-text text-body-secondary">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sDatePickerFormat']) ?>"
                                   maxlength="50"
                                   placeholder="Y-m-d">
                            <small class="form-text text-body-secondary">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sDatePickerPlaceHolder']) ?>"
                                   maxlength="50"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   id="sPhoneFormat"
                                   name="sPhoneFormat"
                                   value="<?= InputUtils::escapeHTML($churchInfo['sPhoneFormat']) ?>"
                                   maxlength="50"
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sPhoneFormatCell']) ?>"
                                   maxlength="50"
                                   placeholder="(999) 999-9999">
                            <small class="form-text text-body-secondary">
                                <?= gettext('Default: (999) 999-9999') ?>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"
                                   ...
                                   value="<?= InputUtils::escapeHTML($churchInfo['sPhoneFormatWithExt']) ?>"
                                   maxlength="50"
