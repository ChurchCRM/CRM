      ...
      <table class="table table-simple-padding">
        ...
        <tr>
          <td colspan="2" class="text-center">
            ...
            <input type="button" class="btn btn-secondary" value="<?= gettext('Cancel') ?>" name="Cancel" onclick="javascript:document.location='<?= $linkBack !== '' ? RedirectUtils::escapeRedirectUrl($linkBack, 'PersonView.php?PersonID=' . $iPerson) : 'PersonView.php?PersonID=' . $iPerson ?>';">
          </td>
        </tr>
      </table>
    </form>
