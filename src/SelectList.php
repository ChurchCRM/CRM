...
while ($aRow = mysqli_fetch_array($rsPersons)) {
    ...
    <td><img data-src="<?=$sRootPath?>/api/persons/<?= $per_ID ?>/thumbnail" data-name="<?= $per_FirstName.' '.$per_LastName ?>" class="initials-image direct-chat-img " width="10px" height="10px" /> </td>
	<td>
