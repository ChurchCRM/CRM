  ...
  <div class="col-lg-7">
    ...
    echo ' checked';
          ...
          <div class="row">
            ...
            <div class="col-lg-4" style="text-align:center">
			  <label for="ShowBillCounts"><?php echo gettext('Show Bill Counts:'); ?></label>
              <input type="checkbox" name="ShowBillCounts" id="ShowBillCounts" value="1" checked />
            </div>
            <div class="col-lg-3" style="text-align:center">
              <input type="button" class="btn" value="<?php echo gettext('Deposit Slip Report'); ?>" name="DepositSlipGeneratePDF" onclick="window.CRM.VerifyThenLoadAPIContent(window.CRM.root + '/api/deposits/<?php echo $thisDeposit->getId() ?>/pdf/' + $('#ShowBillCounts').is(':checked'));">
            </div>
          </div>
          <?php
