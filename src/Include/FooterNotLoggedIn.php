...
?>
    <div class="text-center" style="background-color: white; padding-top: 5px; padding-bottom: 5px; position: fixed; bottom: 0; width: 100%">
      ...
      <div class="mt-1">
        <a href="https://www.facebook.com/getChurchCRM" target="_blank" rel="noopener noreferrer"><?= gettext("Facebook") ?> <i class="fa-brands fa-facebook"></i></a>
        &nbsp;|&nbsp;
        <a href="https://www.instagram.com/getchurchcrm/" target="_blank" rel="noopener noreferrer"><?= gettext("Instagram") ?> <i class="fa-brands fa-instagram"></i></a>
        &nbsp;|&nbsp;
        <a href="https://x.com/getChurchCRM" target="_blank" rel="noopener noreferrer"><?= gettext("X") ?> <i class="fa-brands fa-x-twitter"></i></a>
        &nbsp;|&nbsp;
        <a href="https://www.linkedin.com/company/getchurchcrm/" target="_blank" rel="noopener noreferrer"><?= gettext("LinkedIn") ?> <i class="fa-brands fa-linkedin"></i></a>
        &nbsp;|&nbsp;
        <a href="https://www.youtube.com/@getChurchCRM" target="_blank" rel="noopener noreferrer"><?= gettext("YouTube") ?> <i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
