...
<script src="<?= SystemURLs::getRootPath() ?>/skin/adminlte/plugins/select2/i18n/<?= $localeInfo->getShortLocale() ?>.js"></script>
<script>
	$(".multiSearch").select2.defaults.set("language", "<?= $localeInfo->getShortLocale() ?>");
</script>
