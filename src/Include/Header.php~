...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= SystemURLs::getRootPath() ?>/Menu.php" class="logo">
      ...
      <span class="logo-mini"><img src="/Images/logomarca_branca_peq.png" style="height:40px";></span>
      ...
      ?>
      <span class="logo-lg"><img src="/Images/Logotipo_Branco_mini.png" style="height:40px";></span>
    </a>
