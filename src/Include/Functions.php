...
function formCustomField($type, $fieldname, $data, $special, $bFirstPassFlag)
{
    ...
    case 2:
      ...
      echo '<div class="input-group">'.
        ...
        '</div>'.
        '<input class="form-control date-picker" type="text" id="'.$fieldname.'" Name="'.$fieldname.'" value="'.((strtotime($data) != "")?date(SystemConfig::getValue("sDateFormatLong"), strtotime($data)):strtotime($data)).'" placeholder="'.SystemConfig::getValue("sDatePickerPlaceHolder").'"> '.
        '</div>';
      break;
